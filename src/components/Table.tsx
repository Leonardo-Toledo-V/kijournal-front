                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        {currentProducts.length > 0 ? (
                                            currentProducts.map((producto) => (
                                                <tr key={producto.id}> {/* Utiliza el id del producto como clave */}
                        ...
                        <div className="flex items-center justify-center min-h-screen">
                            ...
                            <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    {selectedProduct ? ( // Verifica si hay un producto seleccionado (si estamos en modo edición)
                                        <>
                                            <button
                                                onClick={editProduct} // Llama a editProduct al hacer clic en el botón "Guardar" solo si estamos en modo edición
                                    ...
                                    ) : ( // Si no hay ningún producto seleccionado, significa que estamos en modo de agregar
                                        <>
                                            <button
                                                onClick={addProduct} // Llama a addProduct al hacer clic en el botón "Guardar" solo si estamos en modo de agregar
                                                className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#468e4d] text-base font-medium text-white hover:bg-[#2f693e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#468e4d] sm:ml-3 sm:w-auto sm:text-sm"
                                            >
                                                Guardar
                                            </button>
